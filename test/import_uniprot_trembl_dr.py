...
from src.pmcad.core import pg_exec, import_uniprot_dr

pvpath = "/data/wyuan/local/bin/pv"
dbpath = "/data/wyuan/workspace/pmcdata_pro/database/protease_pgdb"

from src.pmcad.core import import_uniprot_dr

table_name = "uniprot_trembl_dr"
...
import_uniprot_dr(dbpath, UNIPROT_GZ, table_name=table_name, batch_commit=1000000)