...
from src.pmcad.doid_search import search_doid

from src.pmcad.doid_map import process_one_folder_get_doid_id
from src.pmcad.doid_judge import process_one_folder_judge_doid_id
...
process_folder_parallel(
    folder=folder, 
    process_one_folder=process_one_folder_get_doid_id,
    workers=32, 
    input_name="ds.json", 
    output_name="ds_doid.json",
    limit=limit,
    search_func= lambda query: search_doid(
        query=query,
...
results = process_folder_parallel(
    folder=folder,
    process_one_folder=process_one_folder_judge_doid_id,
    input_name="ds_doid.json",
    output_name="ds_doid.json",
    workers=16,
    limit=limit,
    llm=llm
