...
from src.pmcad.so_map import process_one_folder_get_so_id
from src.pmcad.so_judge import process_one_folder_judge_so_id
...
process_folder_parallel(
    folder=folder, 
    process_one_folder=process_one_folder_get_so_id,
    workers=32, 
    input_name="ds.json", 
    output_name="ds_so.json",
    limit=limit,
    search_func= lambda query: search_so(
        query=query,
...
results = process_folder_parallel(
    folder=folder,
    process_one_folder=process_one_folder_judge_so_id,
    input_name="ds_so.json",
    output_name="ds_so.json",
    workers=16,
    limit=limit,
    llm=llm
